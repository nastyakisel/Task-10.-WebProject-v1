...
<body>
	<div class="registration">
		<form method="post" action="controller.html" >
			...
			Id
			<br />
			<input type="text" id="cat_id" name="cat_id" value="<c:out value='${drug.id}' default=''  />" disabled />
			...
			Инструкция
			<br />
			<textarea name="instruction" cols="60" rows="7"><c:out value='${drug.instruction}' default=''  />
			</textarea>
